  ...
  <Card className="bg-primary/5 border-primary/20 mb-8">
    <CardContent className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div>
          <p className="text-sm text-muted-foreground">Deposit Credit</p>
      ...
      <div className="mt-4 pt-4 border-t border-primary/20">
        <div className="flex justify-between items-center">
          ...
          <p className="text-3xl font-bold text-primary">${(combinedTotals.totalBillable - 100).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
        </div>
      </div>
...
export default function TelescopeMappingReportClient() {
  return (
    <ReportPasswordGate>
        ...
        <header className="bg-primary py-8 px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
              <a
                href="https://telescopemapping.com/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block"
              >
                <div className="h-20 md:h-24 bg-white rounded-lg p-4 flex items-center justify-center">
                  <span className="text-2xl md:text-3xl font-bold text-gray-900">Telescope Mapping</span>
                </div>
              </a>
              <div>
