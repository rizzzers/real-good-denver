    ...
    <CardContent className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <p className="text-3xl font-bold text-primary">${combinedTotals.totalBillable.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
        </div>
      </div>
...
export default function MotorStreet360ReportClient() {
  return (
    <ReportPasswordGate>
        ...
        <header className="bg-primary py-8 px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
              <a
                href="https://motorstreet360.com/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block"
              >
                <div className="h-20 md:h-24 bg-white rounded-lg p-4 flex items-center justify-center">
                  <span className="text-2xl md:text-3xl font-bold text-gray-900">MotorStreet360</span>
                </div>
              </a>
              <div>
