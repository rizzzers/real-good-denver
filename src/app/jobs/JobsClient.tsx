...
import { Target, MapPin, Bell, Building2, CheckCircle } from 'lucide-react';
...
export default function JobsClient() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden bg-foreground pt-28 pb-16">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
          ...
          <div id="job-form" className="rounded-2xl overflow-hidden shadow-2xl">
            <iframe
              src="https://forms.jobstream.co/real-good-denver/"
              title="Job Alerts Sign Up"
