...
export const communityEvents: CommunityEvent[] = [
  ...
  {
    id: "boulder-burgundy-festival-2026",
    title: "Boulder Burgundy Festival",
    date: "2026-10-24",
    time: "Oct. 24-25",
    location: "Flagstaff House and Academy at Mapleton Hill, Boulder, CO",
    description:
