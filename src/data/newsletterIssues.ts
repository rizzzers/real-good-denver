...
export const newsletterIssues: NewsletterIssue[] = [
  ...
  },
  {
    ...
    date: "2025-02-19",
    description: "This week: A Denver Norteño legend takes the stage, federal strikes impact healthcare funding, and more local news and events.",
  ...
  {
    slug: "denver-layoffs-wolves-water-wars-200m-tab",
    title: "Denver layoffs, wolves, and water wars while the city runs a $200M tab",
    date: "2025-01-08",
    description: "Denver faces layoffs, wolf reintroduction debates, and water wars as the city racks up a $200M tab.",
    htmlFile: "/newsletter-issues/denver-layoffs-wolves-water-wars-200m-tab.html",
  },
  {
    slug: "denver-newest-bar-tokyo-acid-trip-neon-city",
    title: "Denver's newest bar is a Tokyo acid trip inside the Neon city that's already raising eyebrows",
    date: "2025-01-04",
  ...
  {
    slug: "denver-new-stadiums-towers-food-bank-lines",
    title: "Denver's new stadiums, new towers, new promises as food bank lines stretch longer this winter",
    date: "2025-01-01",
    description: "New stadiums and towers rise in Denver while food bank lines grow longer this winter.",
    htmlFile: "/newsletter-issues/denver-new-stadiums-towers-food-bank-lines.html",
  },
  {
    slug: "denver-vaporwave-christmas-airport-wildlife-crossing",
    title: "Denver Vaporwave Christmas Parties, Airport Showdowns, and a Very Quiet Wildlife Crossing",
    date: "2024-12-18",
    description: "Vaporwave Christmas parties, airport drama, and wildlife crossings round out Denver's holiday season.",
    htmlFile: "/newsletter-issues/denver-vaporwave-christmas-airport-wildlife-crossing.html",
  },
  {
    slug: "denver-politicians-fight-trash-fuel-small-businesses",
    title: "Denver politicians fight, trash turns to fuel, and small businesses pay the holiday price",
    date: "2024-12-11",
    description: "Denver politicians clash, trash-to-fuel innovation emerges, and small businesses face holiday pressures.",
    htmlFile: "/newsletter-issues/denver-politicians-fight-trash-fuel-small-businesses.html",
  },
  {
    slug: "denver-protests-skater-court-winter-hikes",
    title: "Denver protests skater's court date + Guided winter hikes under December skies",
    date: "2024-12-04",
    description: "Denver rallies for a skater's court date and guided winter hikes light up December skies.",
    htmlFile: "/newsletter-issues/denver-protests-skater-court-winter-hikes.html",
  },
];
